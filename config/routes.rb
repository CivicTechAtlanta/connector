Rails.application.routes.draw do
  ...
  get '/donate', to: redirect('https://secure.codeforamerica.org/page/contribute/donate-to-a-brigade-today?source_codes=Brigade-page&brigade=Code%20for%20Atlanta')
