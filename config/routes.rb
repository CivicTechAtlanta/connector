Rails.application.routes.draw do
  ...
  get '/donate', to: redirect('https://secure.codeforamerica.org/page/contribute/donate-to-a-brigade-today?source_codes=codeforatlanta&brigade=Code%20for%20Atlanta')
